...
def load_dynamic_config(misc_dict: Dict[str, Alphabet]) -> Tuple[Alphabet, Alphabet, Alphabet, Alphabet]:
    voc_iv_dict = misc_dict['voc_iv_dict']
    voc_ooev_dict = misc_dict['voc_ooev_dict']
    char_dict = misc_dict['char_dict']
    label_dict = misc_dict['label_dict']

    return voc_iv_dict, voc_ooev_dict, char_dict, label_dict


def save_dynamic_config(reader) -> Dict[str, Alphabet]:
    misc_dict = dict()
    misc_dict['voc_iv_dict'] = reader.word_iv_alphabet
    misc_dict['voc_ooev_dict'] = reader.word_ooev_alphabet
    misc_dict['char_dict'] = reader.char_alphabet
